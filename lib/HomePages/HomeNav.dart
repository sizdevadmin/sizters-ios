                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Hero(
                                        tag:controller. productList[index]["image_id"].toString(),
                                        child: CachedNetworkImage(
                                         imageUrl:controller. productList[index]["img_url"].toString(),
                                          fit: BoxFit.cover,
                                          height: 300,
                                          width: 200,
                                        ),
                                      ...
                                      child: Column(
                                        ...
                                        crossAxisAlignment:
                                          ...
                                          Container(
                                            ...
                                            margin: const EdgeInsets.only(),
                                            child: Text(
                                           controller. productList[index]["brand_name"].toString(),
                                            maxLines: 1,
                                          ...
                                          Text(
                                           controller. productList[index]["category_id"].toString()=="1"?
