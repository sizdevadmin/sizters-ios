...
String? selectedyearRender;
  ...
  getmyRentals(int pageno) async {
    ...
    try {
      final response = await http.post(Uri.parse(SizValue.myrentals),
  ...
  getcalenderData() async {
    ...
    try {
      ...
      if (calenderResponse["success"] == true) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(calenderResponse["error"].toString(),style: GoogleFonts.lexendDeca(fontSize: 13,fontWeight: FontWeight.w300,color: Colors.white))));
      }
    } on ClientException {
      mysnackbar(
          "Server not responding please try again after sometimev fg", context);
      ...
      if (requestApproveRejectedResponse["success"] == true) {
        setState(() {
          decordedrequestResponse[index]["status"] =requestApproveRejectedResponse["status"];
           ...
           controller.decordedlendingReponse["pending_request"]=requestApproveRejectedResponse["pending_rental"].toString();
           controller.forseUpdate();
         
        });
      } else if (requestApproveRejectedResponse["success"] == false) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: Text(requestApproveRejectedResponse["error"].toString(),style: GoogleFonts.lexendDeca(fontSize: 13,fontWeight: FontWeight.w300,color: Colors.white))));
      }
    } on ClientException {
      mysnackbar(
          "Server not responding please try again after sometimev fg", context);
  ...
  updateAllClosets() async {
    ...
    try {
      ...
      if (allclosetsResponse["success"] == true) {
        setState(() {
          controller.closetsReponse["closet_status"] =allclosetsResponse["status"].toString();
        });
        ...
        Navigator.pop(context);
        ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(allclosetsResponse["error"].toString(),style: GoogleFonts.lexendDeca(fontSize: 13,fontWeight: FontWeight.w300,color: Colors.white))));
      }
    } on ClientException {
      Navigator.pop(context);
      mysnackbar(
  ...
  dialodShow(BuildContext context) {
    ...
    _scrollControllerMC.addListener(() {
      ...
      if (_scrollControllerMC.offset >=_scrollControllerMC.position.maxScrollExtent-400) {
...
// my list pagination ==========================================================
  ...
  final ScrollController _scrollControllerMR=ScrollController();
    ...
    _scrollControllerMR.addListener(() {
      ...
      if (_scrollControllerMR.offset >=_scrollControllerMR.position.maxScrollExtent-400) {
          ...
          return SafeArea(
           ...
           Container(
                                    ...
                                    Container(
                                      ...
                                      child: LottieBuilder.asset("assets/images/underprocess.json",fit: BoxFit.cover,width: 100,height: 100,)),
                                     Container(
                                     ...
                                     InkWell(
                                      onTap: () {
                                       ...
                                       child: Container(
                                        ...
                                        child: Text("Back to home".toUpperCase(),style: GoogleFonts.lexendExa(
                                           color: Colors.white,
                                          fontSize: 16,
                                          fontWeight: FontWeight.w300
                                        ),),
                      ...
                      MaterialPageRoute(
                          builder: (context) => LoginPage(email: "")));
                                  ...
                                  Container(
                                    ...
                                    Container(
                                      margin: const EdgeInsets.only(bottom: 20),
                                      child: LottieBuilder.asset("assets/images/rejectanimation.json",fit: BoxFit.cover,width: 100,height: 100,)),
                                     Container(
                                      alignment: Alignment.center,
                                    ...
                                    Navigator.pushAndRemoveUntil(
                                       ...
                                       child: Container(
                                        ...
                                        child: Text("LOGOUT".toUpperCase(),style: GoogleFonts.lexendExa(
                                           color: Colors.white,
                                          fontSize: 16,
                                          fontWeight: FontWeight.w300
                                        ),),
                                   ...
                                   Container(
                                    ...
                                    Container(
                                      margin: const EdgeInsets.only(bottom: 20),
                                      child: LottieBuilder.asset("assets/images/incomplete.json",fit: BoxFit.cover,width: 100,height: 100,)),
                                     Container(
                                      alignment: Alignment.center,
                                     ...
                                     InkWell(
                                      onTap: ()async {
                                       ...
                                       child: Container(
                                        ...
                                        child: Text("COMPLETE SIGNUP".toUpperCase(),style: GoogleFonts.lexendExa(
                                           color: Colors.white,
                                          fontSize: 16,
                                          fontWeight: FontWeight.w300
                                        ),),
                                    ...
                                    Container(
                                     ...
                                     InkWell(
                                      onTap: ()async {
                                        ...
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=> BasicLoginInfo(fromWhere: controller.source)));
                                     ...
                                     InkWell(
                                      onTap: ()async {
                                       ...
                                       child: Container(
                                        ...
                                        child: Text("Login".toUpperCase(),style: GoogleFonts.lexendExa(
                                           color: Colors.white,
                                          fontSize: 16,
                                          fontWeight: FontWeight.w300
                                        ),),
              ...
              Column(
                children: [
                      ...
                      children: [
                        ...
                        InkWell(
                            ...
                            child: SvgPicture.asset(
                                "assets/images/threeline.svg",width: 20,height: 20,)),
                      ],
                    ),
                  ),
                  ...
                  child: TabBar(
                    ...
                    indicator: const BoxDecoration(color: MyColors.themecolor),
                              ...
                              children: [
                                           ...
                                           Container(
                                            margin: const EdgeInsets.only(left: 5),
                                             ...
                                             RatingBarIndicator(
                                               ...
                                               rating:  controller.  decordedlendingReponse
                                                       .isEmpty
                                                   ? 0
                                                   : double.parse(
                                               ...
                                               direction:
                                                  ...
                                                  InkWell(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      alignment: Alignment.center,
                                                      child: SvgPicture.asset("assets/images/editsmall.svg"),
                                                    ),
                                                  )
                                      ...
                                      Expanded(
                                        child: Row(
                                          children: [
                                            ...
                                            Container(
                                              margin: const EdgeInsets.only(left: 10),
                                              child: Text("SIZ CREDITS",style: GoogleFonts.lexendExa(
                                            ...
                                            Container(
                                              margin: const EdgeInsets.only(left: 10),
                                              child: Text(  controller. decordedlendingReponse.isEmpty?"": "AED "+  controller. decordedlendingReponse[
                                                                            "total_balance"]
                                                                        .toString(),style: GoogleFonts.lexendExa(
                                       ...
                                       InkWell(
                                        ...
                                        () {
                                          Navigator.push(context, MaterialPageRoute(builder: (context)=>CreditPage(earning:  controller.  decordedlendingReponse[ "current_balance"] .toString(),totalearning: controller.  decordedlendingReponse[ "total_balance"] .toString())));
                                        },
                                          child: Container(
                                          alignment: Alignment.center,
                                                        margin:
                                                     ...
                                                     height: 31,
                                                        decoration:  BoxDecoration(
                                                          color:  controller. decordedlendingReponse[
                                                                            "current_balance"]
                                                                        .toString()=="0"?Colors.grey:   Colors.black,
                                                          borderRadius:
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.center,
                                                children: [
                                                  Text("AED",style: GoogleFonts.lexendDeca(
                                                    fontWeight: FontWeight.w300,
                                                    color: MyColors.themecolor,
                                                    fontSize: 25,
                                                ...
                                                Container(
                                                  ...
                                                  child: Text("TOTAL INCOME",style: GoogleFonts.lexendExa(
                                                      fontWeight: FontWeight.w300,
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.center,
                                                ...
                                                Container(
                                                  margin: const EdgeInsets.only(top: 10),
                                                  child: Text("PENDING REQUESTS",style: GoogleFonts.lexendExa(
                                                      fontWeight: FontWeight.w300,
                                                      color: const Color(0xff868E96),
                                                      fontSize: 12,
                                   ...
                                   child: DropdownButtonHideUnderline(
                                         child: DropdownButton2<String>(
                                           ...
                                           items: yearslending
                                               ...
                                               .toList(),
                                           value: selectedyearLender,
                                           onChanged: (String? value) {
                                             setState(() {
                                               selectedyearLender = value;
                                                 controller. getaccontDetails(context,selectedyearLender.toString());
                                             });
                                           },
...
// graph bar and values ========================================================================================
                                ...
                                Row(
                                  ...
                                  children: [
                                    AnimatedContainer(
                                      ...
                                      width: MediaQuery.of(context).size.width,
                                      height: controller.  lentingGraph.isEmpty?100:250 ,
                                        ...
                                        child: DChartBarO(
                                          ...
                                          radius: 0,
                                            ...
                                            groupList: [
                                              OrdinalGroup(
                                                id: '1',
                                                data:  controller.  lentingGraph.map((e) => 
              ...
              indicatorWeight: 4,
                                      ...
                                      tabs:  [
                                        ...
                                        const Tab(text: "MY CLOSET"),
                                     controller. decordedlendingReponse["pending_request"].toString()=="0"? 
                                      
                                         const Tab(text: "REQUESTS"):
                                      
                                       badges.Badge(
                                      
                                          badgeContent: Text(controller. decordedlendingReponse.isEmpty?"": controller. decordedlendingReponse["pending_request"].toString(),style: GoogleFonts.lexendDeca(
                                            fontSize: 10,
                                            color: Colors.white
                                          ),),
                                ...
                                SizedBox(
                                  ...
                                  child: TabBarView(
                                      ...
                                      children: [
                                        ...
                                        controller
                                                .decordedClosetsResponse.isEmpty && pagenoMC==1
                                            ? Center(
                                                child: Text(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    "1"?
                                                                                        ...
                                                                                        overflow: TextOverflow.ellipsis,
                                                                                          ...
                                                                                          style: GoogleFonts.lexendDeca(color: const Color.fromARGB(255, 168, 168, 168), fontWeight: FontWeight.w300, fontSize: 11)),
                                     ...
                                     visible: controller.showLazyIndicator,
                                      ...
                                      child: Positioned(
                                       bottom: 0,
                                        ...
                                        decordedrequestResponse.isEmpty && pagenoMR==1
                                            ? Center(
                                                child: Text(
                                                  "No Requests",
                                                  style:  GoogleFonts.lexendDeca(
                                ...
                                Container(
                                 ...
                                 Container( 
                                  ...
                                  child: Stack(
                                    alignment: Alignment.center,
                                    children: [
                                      Image.asset("assets/images/CO2bg.png",height: 50, width: MediaQuery.of(context).size.width,),
                                      ...
                                      Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Text("SAVED CO2 FOOTPRINTS",style: GoogleFonts.lexendExa(
                                              fontSize: 12,
                                              fontWeight: FontWeight.w300,
                                              
                                            ),),
                                            Text(controller.  decordedrentingReponse.isEmpty
                                                ? ""
                                                :controller.  decordedrentingReponse[
                                                            "co2_saved"]
                                                        .toString()+
                                                     " Tonnes",style: GoogleFonts.lexendDeca(
                                              color: const Color.fromARGB(255, 37, 95, 128),
                                              fontSize: 25,
                                              fontWeight: FontWeight.w300,
                                 ...
                                 Container(
                                  ...
                                  child: Row(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.center,
                                                ...
                                                Container(
                                                  margin: const EdgeInsets.only(top: 10),
                                                  child: Text("TOTAL SAVINGS",style: GoogleFonts.lexendExa(
                                                      fontWeight: FontWeight.w300,
                                                      color: const Color(0xff868E96),
                                                      fontSize: 12,
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.center,
                                                ...
                                                Container(
                                                  margin: const EdgeInsets.only(top: 10),
                                                  child: Text("SAVINGS PERCENTAGE",style: GoogleFonts.lexendExa(
                                                      fontWeight: FontWeight.w300,
                                                      color: const Color(0xff868E96),
                                                      fontSize: 12,
                                   ...
                                   child: DropdownButtonHideUnderline(
                                         child: DropdownButton2<String>(
                                           ...
                                           items: yearsrenting
                                               ...
                                               .toList(),
                                           value: selectedyearRender,
                                           onChanged: (String? value) {
                                             setState(() {
                                               selectedyearRender = value;
                                                 controller. getaccontDetails(context,selectedyearRender.toString());
                                             });
                                           },
                                           buttonStyleData: const ButtonStyleData(
                                             padding: EdgeInsets.symmetric(horizontal: 16),
                                ...
                                Row(
                                  ...
                                  children: [
                                    AnimatedContainer(
                                      ...
                                      padding: const EdgeInsets.only(left: 30,bottom: 10),
                                      width: MediaQuery.of(context).size.width,
                                  height:controller. rentingGraph.isEmpty?100:250,
                                      child: DefaultTextStyle(
                                         ...
                                         configRenderBar: ConfigRenderBar(
                                          radius: 0,
                                            ...
                                            groupList: [
                                              OrdinalGroup(
                                                id: '1',
                                                data:  controller. rentingGraph.map((e) => 
                                                      ...
                                                      child: Text(
                                                        "RENT AED " +
                                                            decordedMyrentalReponse[
                                                                        index]
                                                                    ["total_amount"]
                                                                 .toString() + " | "+decordedMyrentalReponse[
                                                                        index]
                                                                    ["days"]
                                                                .toString()+ " DAYS",
                                                        overflow:
