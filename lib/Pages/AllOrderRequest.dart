  ...
  Future<void> scrollListenerMR() async {
    ...
    _scrollControllerMR.addListener(() {
      if (_scrollControllerMR.offset >=
          _scrollControllerMR.position.maxScrollExtent - 200) {
        setState(() {
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                margin: const EdgeInsets.only(
                                                    bottom: 10),
                                                child: Text(
                                                    "AED ${decordedrequestResponse[index]["amount"]}",
                                                    maxLines: 1,
                                                    overflow:
                                                        TextOverflow.ellipsis,
                                                    style:
                                              ...
                                              Container(
                                                alignment: Alignment.centerLeft,
                                                child: Text(
                                                    "${decordedrequestResponse[index]["start_date"]}",
                                                    maxLines: 1,
                                                    overflow:
                                                        TextOverflow.ellipsis,
                                                    style:
                                              ...
                                              Container(
                                                alignment: Alignment.centerLeft,
                                                child: Text(
                                                    "${decordedrequestResponse[index]["end_date"]}",
                                                    maxLines: 1,
                                                    overflow:
                                                        TextOverflow.ellipsis,
                                                    style:
                                                                      ...
                                                                      children: [
                                                                        InkWell(
                                                                          onTap:
                                                                              () {
                                                                            renterReviewDialog(
                                                                                decordedrequestResponse[index]["id"].toString(),
                                                                                decordedrequestResponse[index]["username"].toString(),
                                                                                decordedrequestResponse[index]["profile_img"].toString());
                                                                          },
                                                                          child:
                                                                              Container(
                                                                            alignment:
